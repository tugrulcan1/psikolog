...
<section class="intro_section page_mainslider ds">
				<div class="flexslider">
					<ul class="slides">
						<li>
							<img src="images/sanatterapisi2.jpg"  alt="">
							<div class="container">
								<div class="row">
						...
						<li>
							<img src="images/freudmuzesi.jpg"  alt="">
							<div class="container">
								<div class="row">
									<div class="col-sm-12 text-center">
										<div class="slide_description_wrapper">
			...
			<section id="services" class="ls section_padding_top_130 section_padding_bottom_100">
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h2 class="section_header with_icon">Hizmetlerimiz</h2>
					...
					@foreach($projects as $project)
						<div class="col-md-3 col-sm-6">
							<div class="with_padding text-center teaser hover_shadow">
								...
								<h4>
									<a href="service-single.html"></a>{{$project['project_title']}}
								</h4>
								<p>
								{!!$project['description']!!}
								</p>
